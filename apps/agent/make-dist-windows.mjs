...
writeFileSync(
  ...
  [
    ...
    "echo (You can close this window - background sync keeps running. Later, the QualiFlow web 'Add channel' button reopens it.)",
    "echo.",
